...
フロントエンドはHTML、CSS、JavaScriptで構成され、価格取得APIはPythonと[`yfinance`](https://pypi.org/project/yfinance/)で実装されています。ローカル開発ではBottle、本番環境ではGitHub PagesとAWS Lambdaを利用する構成です。
...
<p align="center">
  <img src=".github/image1.png" alt="Stroidのスクリーンショット">
</p>
