...
[![stroid-deploy-pages](https://github.com/BEROCHLU/stroid/actions/workflows/stroid-deploy-pages.yml/badge.svg)](https://github.com/BEROCHLU/stroid/actions/workflows/stroid-deploy-pages.yml)
...
The frontend is built with HTML, CSS, and JavaScript. The price API is implemented in Python using [`yfinance`](https://pypi.org/project/yfinance/). Bottle is used for local development, while the production setup uses GitHub Pages and AWS Lambda.
